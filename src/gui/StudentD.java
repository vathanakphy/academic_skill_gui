...
public class StudentD extends javax.swing.JFrame {
     ...
     */
    StudentDashboard std =  null;
    public StudentD(String sid) {
        initComponents();
        std = new StudentDashboard(sid);
        std.setSize(jPanel1.getSize()); // Set panel size to match container
        jPanel1.add(std); // Add JPanel to container panel
...
//        </editor-fold>
            if (args != null && args.length == 2) {
                ...
                String uid = args[1]; // Password passed as the second argument
                student = (Student) form.loadData(uid);
            } else {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            new StudentD(args[1]).setVisible(true);
        });
    }
