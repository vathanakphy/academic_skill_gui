...
//    Connection conn = MySQLConnection.getConnection();
 ...
 Connection conn = null;
    ...
    try {
        ...
        // Check if Teacher ID exists before updating
        String checkSQL = "SELECT COUNT(*) FROM User WHERE id = ?";
        PreparedStatement checkStmt = conn.prepareStatement(checkSQL);
        checkStmt.setString(1, "T1"); // Use the correct Teacher ID
        ...
        stmt.setString(8, "T1"); // Teacher ID (make this dynamic)

        // Execute Update
        int rowsUpdated = stmt.executeUpdate();
        if (rowsUpdated > 0) {
            JOptionPane.showMessageDialog(this, "Teacher information updated successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
        } else {
