...
public class TeacherD extends javax.swing.JFrame {
     ...
     */
    TeacherDashboard tdb = null; 
    public TeacherD() {
        initComponents();
        
        tdb = new TeacherDashboard(); // Create the TeacherDashboard panel
        tdb.setSize(jPanel1.getSize()); // Set panel size to match container
        jPanel1.add(tdb); // Add JPanel to container panel
...
//        </editor-fold>
            if (args != null && args.length == 2) {
                ...
                String tid = args[1]; // Password passed as the second argument
                teacher = (Teacher) form.loadData(tid);
            } else {
